...
internal class Sabar: Human
{
    init() {
        ...
        super.walk2Textures.append(SKTexture(imageNamed: "avatar.human.saber.walk.2.0.png"))
        super.walk2Textures.append(SKTexture(imageNamed: "avatar.human.saber.walk.2.1.png"))
        super.walk2Textures.append(SKTexture(imageNamed: "avatar.human.saber.walk.2.2.png"))
    }
}